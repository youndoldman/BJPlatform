...
{
    private Integer id;
    private String  securitySn;//安检单编号
    private SecurityType securityType;//安检类型
    Customer customer;//安检人

    private String recvName;//收货人名称
    private String recvPhone;//收货人电话
    private CustomerAddress recvAddr; //安检地址
    private String  detail;//安检详情
