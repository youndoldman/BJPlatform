manageApp.controller('DepartmentSelectModalCtrl', ['$scope', 'close', 'UserService', 'title', 'initVal','$timeout','$interval', function ($scope, close, UserService, title, initVal,$timeout,$interval) {
    $scope.dataSource = {};
    $scope.chart = null;
