 ...
 */
shopManageApp.controller('DepartmentSelectModalCtrl', ['$scope', 'close', 'title', 'initVal','$timeout','$interval','ShopStockService', function ($scope, close, title, initVal,$timeout,$interval,ShopStockService) {
    $scope.dataSource = {};
    $scope.chart = null;
    ...
    var retrieveRootDepartment = function () {
        ShopStockService.retrieveDepartmentLower("root").then(function (rootDepartment) {
